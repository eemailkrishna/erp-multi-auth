...
Route::post('/add-enquiry-post', [EnquiryController::class, 'add_enquiry'])->name('addenquery');
...
Route::get('/enquiry-delete/{id}',[EnquiryController::class,'enquiry_delete'])->name('enquiry_delete');
Route::get('/enquiry-edit/{id}',[EnquiryController::class,'enquiry_Edit'])->name('enquiry_Edit');
Route::post('/enquiry-edit/{id}',[EnquiryController::class,'update_enquiry'])->name('update_enquiry');
...
Route::post('/penalty-form', [PenalityController::class, 'penaltyform']);
...
Route::get('/penalty-delete/{id}',[PenalityController::class,'penalty_delete'])->name('penalty_delete');
...
Route::post('/penalty-delete/{id}',[PenalityController::class,'penalty_del']);
...
// Route::post('/fetch-sections/{id}',[HomeWorkController::class,'fetchSection'])->name('fetch-sections');
...
Route::group(['middleware' => ['auth', 'role:superadmin']], function () {
    Route::get("check1", [SuperadminDashboardController::class, 'index']);
});
Route::group(['middleware' => ['auth', 'role:admin']], function () {
    Route::get("check2", [AdminDashboardController::class, 'index']);
});
