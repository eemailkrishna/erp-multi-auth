...
<!------------------------------------------------Start Registration form--------------------------------------------------->
	<form action="{{url('bus/employee-detail')}}" method="post" id="my_form" enctype="multipart/form-data">@csrf	
    <div class="box-body">
		...
		<h3 style="color:#d9534f;"><b>Personal Detail</b></h3>
			<div class="col-md-4 ">
				...
				<div class="form-group">
                    ...
                    <input type="text" required name="emp_name" placeholder="Employee Name"  value="" class="form-control">
                </div>
			...
			<div class="col-md-3 ">				
			 	<div class="form-group">
                  <label>Photo</label>
                   <input type="file" name="emp_photo" id="emp_photo" onchange="check_file_type(this,'emp_photo','emp_phroi12','image');" class="form-control" accept=".gif, .jpg, .jpeg, .png" value="">
                </div>
			</div>	
			<div class="col-md-1 "  >	
					<div class="form-group">
	     ...
	     <div class="col-md-4 ">				
				<div class="form-group">
                    ...
                    <input type="date" name="emp_doj" placeholder="Date Of Joining"  value="2022-12-13" class="form-control">
                </div>
			</div>
			<div class="col-md-4 ">				
				<div class="form-group">
		...
		<h3 style="color:#d9534f;"><b>Salary Details</b></h3>
			<div class="col-md-4 ">				
				<div class="form-group">
                   ...
                   <input type="text" name="emp_pan_card_no" placeholder="Salary Details"  value="" class="form-control">
                </div>
			</div>
			...
			<div class="col-md-4 ">				
				<div class="form-group">
                  ...
                  <input type="text"  name="emp_adhar_no" placeholder="Aadhar No."  value="" class="form-control">
                </div>
			</div>
			...
			<div class="col-md-4 ">				
				<div class="form-group">
                   ...
                   <input type="text" required name="emp_salary" placeholder="Salary"  value="" class="form-control">
                </div>
			</div>
