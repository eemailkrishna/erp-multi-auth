    ...
    <h1>
     ...
     <ol class="breadcrumb">
		...
		<li><a href="javascript:get_content('bus/bus_route_list')"><i class="fa fa-list"></i>Bus Details List</a></li>
				    ...
				    <div class="col-md-4 ">
						<div class="form-group">
						  <label>Bus Route</label>
						   <input type="text"  name="bus_route" placeholder="Bus Route"  value="" class="form-control" readonly>
						</div>
				   </div>
					<div class="col-md-4 ">		
						<div class="form-group">
						  <label>Bus Stop Name</label>
						   <input type="text" name="bus_stop_name" placeholder="Bus Stop Name"  value="mp nagar" class="form-control" >
						</div>
					</div>
					<div class="col-md-4 ">
						<div class="form-group">
						  <label>Bus Route Time</label>
						   <input type="time"  name="bus_route_time"  placeholder="Bus Route Time"  value="19:22" class="form-control" >
						</div>
					</div>
				    <div class="col-md-4 ">		
						<div class="form-group">
						  <label>Bus No.</label>
						  <input type="text" name="bus_no" placeholder="Bus No." readonly value="MH19TS0001" class="form-control" >
						</div>
					</div>
				</div>
