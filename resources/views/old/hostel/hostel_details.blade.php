	 ...
	 <h3 style="color:#d9534f;"><b>Hostel Info</b></h3>
		    <div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="text"  name="hostel_name"   placeholder="Hostel Name"  value="" class="form-control " >
					</div>
				...
				<div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="number"  name="hostel_number_of_room"   placeholder="Number of Room"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4 ">
					<div class="form-group">
						<label> Total Capacity</label>
						<input type="number"  name="hostel_total_capacity"   placeholder="Capacity"  value="" class="form-control">
					</div>
				</div>
				<div class="col-md-4 ">
					<div class="form-group">
			 ...
			 <div class="col-md-4 ">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="hostel_warden_name" placeholder="Warden Name" value="">
					</div>
				</div>
