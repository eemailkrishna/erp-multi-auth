...
<section class="content">
	...
	<div class="row">
		...
		<div class="box box-primary my_border_top">
			...
			<div class="box-body">
				<form role="form" action="{{url('add-enquiry-post')}}" method="POST" id="my_form"
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control" name="enquiry_type" id="enquiry_type" onchange="for_other();"
								required>
					...
					<div class="col-md-4" id="div_enquiry_type_other">
						<div class="form-group">
							<label>Enquiry Type Other<font style="color:red"><b>*</b></font></label>
							<input type="text" value="" name="enquiry_type_other" id="enquiry_type_ohter"
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="date" value="2022-12-03" name="enquiry_date" id="myLocalDate"
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_name" placeholder="Name" value="" class="form-control"
								required>
						</div>
					</div>
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_father_name" placeholder="Father's Name" value=""
								class="form-control">
						</div>
					</div>
					<div class="col-md-4 ">
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_address" placeholder="Address" value=""
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_contact_no" placeholder="Contact No 1." value=""
								class="form-control" required>
						</div>
					</div>
					<!-- <div class="col-md-4 ">
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="date" name="enquiry_next_follow_up_date" placeholder="Date" value=""
								class="form-control">
						</div>
					</div>
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_remark_1" placeholder="Enquiry Remark1" value=""
								class="form-control" required>
						</div>
					</div>
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="previous_school_name" placeholder="Previous School Name" value=""
								class="form-control" required>
						</div>
					</div>
					<div class="col-md-4 ">
					...
					<div class="col-md-4 ">
						<div class="form-group">
							...
							<input type="text" name="enquiry_remark_2" placeholder="Enquiry Remark2" value=""
								class="form-control">
						</div>
					</div>
					...
					<div class="col-md-12">
						<center><input type="submit" name="submit" id="submitButtonId" value="Submit"
