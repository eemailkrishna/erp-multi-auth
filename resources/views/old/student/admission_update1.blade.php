            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select class="form-control" name="Child_With_Special_Need">
                        <option value="{{ $students->admission->child_wiht_spe_need }}">{{ $students->admission->child_wiht_spe_need }}</option>
          ...
          <div class="col-md-3">
            ...
            <div class="col-md-3" style="">
                <div class="form-group">
                    ...
                    <input type="email" name="student_Mother_Contact_No" placeholder="Father Mother Contact No" value="{{ $students->admission->mother_cont_no }}"
                        class="form-control">
                </div>
            </div>
            <div class="col-md-3" style="">
