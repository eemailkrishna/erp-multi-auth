                ...
                <form name="myForm" method="post" id="my_form" enctype="multipart/form-data"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Student_Admission_Class" id="student_class"
                                ...
                                <option value="{{ $students->student->class_id }}">{{ $students->student->class_id }}
                                </option>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="stream" id="student_class"
                                onchange="for_stream(this.value);get_group_subject();" required>
                                <option value="{{ $students->student->stream }}">{{ $students->student->stream }}
                                </option>
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Mother_Contact_No" placeholder="Father Mother Contact No"
                                value="" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3" style="">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="file" id="student_image" name="student_image"
                        ...
                        value="{{ $students->profile_pic }}" class="form-control" accept=".gif, .jpg, .jpeg, .png">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
