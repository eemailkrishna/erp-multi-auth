                                ...
                                <tbody>
                                    ...
                                    @foreach ($studentts as $list)
                                        <tr>
                                            ...
                                            <td>{{ $list->student->doa ?? 'None' }}</td>
                                            <td>{{ $list->student->roll_no ?? 'None' }}</td>
                                            <td>{{ $list->student->block ?? 'None' }}</td>
                                            <td>{{ $list->student->doa ?? 'None' }}</td>
                                            <td>
                                                <a href="{{ url('student/admission-edit/'.$list->id) }}"class="btn btn-info btn-sm">Make
                                                    Admission</a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" onclick="delete_functionn({{ $list->id }})"
