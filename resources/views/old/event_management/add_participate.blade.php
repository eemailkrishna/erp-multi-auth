...
@endif
			<form role="form" method="post" enctype="multipart/form-data" id="my_form">
				...
				<div class="col-md-3">		
				   <div class="form-group">
					  ...
					  <input type="text" name="school_name"  placeholder="School Institute"  value="" class="form-control"  />
				  </div>
				</div>
			...
			<div class="col-md-3">
				<div class="form-group">
					...
					<input type="text" name="student_father_name"  placeholder="Father Name" value="" class="form-control"  >
				</div>
			</div> 
			<div class="col-md-3">
				<div class="form-group">
					<label>Mother Name</label>
					 <input type="text" name="student_mother_name"  placeholder="Mother Name" value="" class="form-control"  >
				</div>
			</div>
			  ...
			  <div class="col-md-3">
				 <div class="form-group" >
				   <label>Class</label>
					<input type="text" name="class" placeholder="Student Class"   class="form-control">
				 </div>
			  </div>
			     ...
			     <div class="col-md-3" id="birth_other">		
					  <div class="form-group">
					    ...
					    <input type="date" name="dateofbirth"  placeholder="Date Of Birth"  value="" class="form-control">
					  </div>
				 </div> 
			  ...
			  <div class="col-md-3">
				<div class="form-group">
					...
					<input type="text"  name="category" required placeholder="Eg:Dancing,Solo Dancing,Singing,etc"   class="form-control" >
				</div>
			</div>
