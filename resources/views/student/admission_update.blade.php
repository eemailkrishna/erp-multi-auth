...
<script>
    function same_address_function() {
        if ($("#same_address_checkbox").is(":checked")) {
            ...
            $("#student_landmark_permanent").val($("#student_landmark").val());
        } else {
            ...
            $("#student_landmark_permanent").val('');
        }
    }
</script>
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-body">
                <form name="myForm" method="post" id="my_form" enctype="multipart/form-data"
                    action="{{ url('/student/admission_update') }}" onsubmit="return validate();">
                    @csrf
                    {{-- personal Details --}}
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_name" id="student_name" required
                                placeholder="student Name" value="{{ $students->user->name }}"
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_father_name" id="student_father_name"
                                placeholder="Father's Name" value="{{ $students->father_name }}"
                                class="form-control new_student">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_mother_name" id="student_mother_name"
                                placeholder="Mother's Name" value="{{$students->mother_name}}"
                                class="form-control new_student">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control new_student" name="student_gender">
                                <option value="{{ $students->user->gender }}">{{ $students->user->gender }}</option>
                            </select>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="Child_With_Special_Need_des" id="student_Mother Qualification"
                                placeholder="Description" value="{{ $students->stu_cwsn_des }}" class="form-control new_student">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Date_Of_Birth_word" placeholder="Date Of Birth(word)"
                                oninput="get_dob_in_words(this.value);" id="student_Date Of Birth(word)"
                                value="" class="form-control new_student" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" id="student_Aadhar Card (Father)" name="student_Aadhar_Card_Father"
                                value="" class="form-control" placeholder="Aadhar Card (Father)">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_registration_number" value="{{ $students->roll_no }}"
                                placeholder="Registration No" class="form-control" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="number" name="Account_Number_Father" placeholder="Account Number (Father)"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="Bank_IFSC_Code_Father" placeholder="Bank IFSC Code (Father)"
                                class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3 ">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_admission_type" id="student_admission_type">
                                <option value="{{ $students->admission_type }}">
                                    {{ $students->admission_type }}</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_admission_scheme">
                                <option value="{{ $students->admission_scheme }}">
                                    {{ $students->admission_scheme }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_old_or_new">
                                <option value="{{ $students->stu_new_old }}">
                                    {{ $students->stu_new_old }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Student_Admission_Class" id="student_class"
                                ...
                                <option value="{{ $students->class->class}}">{{ $students->class->class}}
                                </option>
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="stream" id="student_class"
                                onchange="for_stream(this.value);get_group_subject();" required>
                                <option value="{{ $students->stream }}">{{ $students->stream }}
                                </option>
                    ...
                    <div class="col-md-3" id="student_class_group_subject_div">
                        <div class="form-group">
                            ...
                            <input type="date" name="Date Of Admission" id="student_class_group_subject"
                                value="{{ $students->doa }}"  class="form-control new_student">
                        </div>
                    </div>
                    <div class="col-md-3" id="student_class_group_subject_div">
                        <div class="form-group">
                    ...
                    <div class="col-md-3" id="student_class_group_subject_div">
                        <div class="form-group">
                            ...
                            <input type="text" name="previ_sch_tc_no"
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_shift">
                                <option value="{{ $students->fee_category }}">
                                    {{ $students->fee_category }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label>Bus</label>
                            <select class="form-control"  name="student_shift">
                                <option value="{{ $students->bus }}">{{ $students->bus }}</option>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_Hostel">
                                <option value="{{ $students->hostel }}">{{ $students->hostel }}
                                </option>
                                <option value="No">No</option>
                            </select>
                        </div>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="student_Library">
                                <option value="{{ $students->library }}">{{ $students->library }}
                                </option>
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_registration_fee" placeholder="Registration Fees"
                                value="{{ $students->registration_fee }}" class="form-control">
                        </div>
                    </div> 
                    {{-- Family Contacts --}}
                    <div class="col-md-12">
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Father Contact No." placeholder="Father Contact No."
                                value="{{ $students->father_contact }}" class="form-control">
                        </div>
                    </div>
                     ...
                     <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Father Contact No2."
                                placeholder="Father Contact No2." value="{{ $students->father_contact1 }}"
                                 class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Mother_Contact_No" placeholder="Mother Contact No"
                                value="" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3" style="">
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="SMS Contact Number" placeholder="SMS Contact Number"
                                value="{{ $students->sms_contact }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="hidden" id="student_sssmid_image" name="user_id"                             
                                value="{{ $students->id }}" class="form-control">
                        </div>
                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_adress" id="student_adress"
                                        value="{{ $students->stu_add }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_city" id="student_city"
                                        value="{{ $students->village_city }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_block" id="student_block"
                                        value="{{ $students->block }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_district" id="student_district"
                                        value="{{ $students->district }}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_state" id="student_state"
                                        value="{{ $students->state }}" class="form-control">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_pincode" id="student_pincode"
                                        value="{{ $students->pincode }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="student_landmark" id="student_landmark"
                                        value="{{ $students->landmark }}" class="form-control">
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Landmark</label>
                                <input type="text" name="student_landmark_permanent" id="student_landmark_permanent"
                                    value="" class="form-control">
                            </div>
                        </div>
                    </div>
          ...
          <div class="box-body ">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="file" id="student_image" name="student_image"
                        ...
                        value="{{ $students->user->profile_pic }}" class="form-control" accept=".gif, .jpg, .jpeg, .png">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <input type="file" id="student_guardian_image" name="student_guardian_image" value=""
            ...
            <div class="col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="file" id="student_tc_image" name="student_tc_image"
                        onchange="check_file_type(this,'student_tc_image','show_student_tc','all');" value=""
                        class="form-control" accept=".gif, .jpg, .jpeg, .png">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <img onclick="open_file1('student_tc_image','2201133');"
                        src="../school_software_v1_old/images/student_blank.png" id="show_student_tc" height="50"
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <img onclick="open_file1('student_income_certificate_image','2201133');"
                        src="../school_software_v1_old/images/student_blank.png" id="show_student_income_certificate"
                        height="50" width="50" style="margin-top:10px;">
                </div>
            </div>
            <div class="col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="file" id="student_cast_certificate_image" name="student_cast_certificate_image"
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <img onclick="open_file1('student_cast_certificate_image','2201133');"
                        src="../school_software_v1_old/images/student_blank.png" id="show_student_cast_certificate"
                        height="50" width="50" style="margin-top:10px;">
                </div>
            </div>
            <div class="col-md-2 ">
                <div class="form-group">
                    ...
                    <input type="file" id="student_dob_image" name="student_dob_image"
                        onchange="check_file_type(this,'student_dob_image','show_student_dob','all');" value=""
                        class="form-control" accept=".gif, .jpg, .jpeg, .png">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <img onclick="open_file1('student_dob_image','2201133');"
                        src="../school_software_v1_old/images/student_blank.png" id="show_student_dob" height="50"
                        width="50" style="margin-top:10px;">
                </div>
            </div>
            <div class="col-md-2 ">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <img onclick="open_file1('student_adhar_card_image','2201133');"
                        src="../school_software_v1_old/images/student_blank.png" id="show_adhar_photo" height="50"
                        width="50" style="margin-top:10px;">
                </div>
            </div>
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <input type="hidden" id="student_sssmid_image" name="user_id"
                        onchange="check_file_type(this,'student_sssmid_image','show_sssmid_photo','image');"
                        value="{{ $students->user->id }}" class="form-control" accept=".gif, .jpg, .jpeg, .png">
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="col-md-3 ">
                    <div class="form-group">
                        ...
                        <input type="text" name="student_remark_1" value="{{ $students->remark }}"
                            class="form-control">
                    </div>
                </div>
               
                <div class="col-md-12 ">
                    <input type="hidden" name="sms_school_name" id="sms_school_name" value="SIMPTION TECH PVT LTD"
                        class="form-control">
                    <div class="col-md-8 ">
