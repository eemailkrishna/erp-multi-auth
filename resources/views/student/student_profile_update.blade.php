...
<script type="text/javascript">
    function for_section(id) {
        ...
        $.ajax({
            type: "get",
            url: '{{ url('student/student_profile_generate_section') }}/' + id,
            cache: false,
...
<form role="form" action="{{ url('student/student_profile_generate_update') }}" method="post"
    ...
    $(document).ready(function() {
        $("#student_class").change(function() {
            ...
            $.ajax({
                ...
                url: '{{ url('student/student_profile_team_creation_list_post') }}/' + class_id,
                type: 'get',
        ...
        $("#student_class_section").change(function() {
            ...
            $.ajax({
                url: '{{ url('student/student_profile_list_post_section') }}/' + section_id,
                type: 'get',
                success: function(response) {
                    $('#table-data').html(response.output);
                    $('#section').html(response.section);
