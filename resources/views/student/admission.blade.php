                ...
                <form name="myForm" method="post" id="my_form" enctype="multipart/form-data" action=""
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="Child_With_Special_Need_des" id="student_Mother Qualification"
                                        placeholder="Description" value="" class="form-control new_student">
                    ...
                    <div class="col-md-3 ">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Student_Admission_Class" id="student_class" readonly
                                onchange="for_stream(this.value);get_group_subject();">
                                <option value="{{$students->student->class}}">{{$students->student->class}}</option>
                    ...
                    <div class="col-md-3" style="">
                        <div class="form-group">
                            ...
                            <input type="text" name="student_Mother_Contact_No"
                                placeholder="Mother Contact No" value="" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-3" style="">
                        <div class="form-group">
