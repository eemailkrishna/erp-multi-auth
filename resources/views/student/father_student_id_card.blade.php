...
<script type="text/javascript">
    function for_section(id) {
        ...
        $.ajax({
            type: "get",
            url: '{{ url('/student/father_student_id_card_generate_section') }}/' + id,
            cache: false,
      ...
      <div class="row">
          ...
          <div class="box box-primary my_border_top">
            <div class="box-header with-border ">
              <h3 class="box-title">Father Generate ID</h3>
            </div>
            <!-- /.box-header -->
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            <div class="box-body "  >
					<form role="form"  method="post" id="my_form" action="../school_software_v1_old/pdf/pdf/id_card_page_father/father_id_card.php" onsubmit="return checked_null_value();" enctype="multipart/form-data" target="_blank">
  ...
  $(document).ready(function() {
      $("#student_class").change(function() {
          ...
          $.ajax({
              ...
              url: '{{url('/student/father_team_creation_list_post')}}/'+class_id,
              type: 'get',
      ...
      $("#student_section").change(function() {
          ...
          $.ajax({
              url: '{{url('/student/father_student_team_creation_list_post_section')}}/' + section_id,
              type: 'get',
              success: function(response) {
                  $('#table-data').html(response.output);
                  $('#section').html(response.section);
