            ...
            <a href="{{ url('student/student_registration') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="{{ url('student/student_registration') }}" class="small-box-footer">More Info <i
            ...
            <a href="{{ url('student/student_registration_list_fatch') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <a href="{{ url('student/student_registration_list') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/student_admission') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <a href="{{ url('student/student_admission_list') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="javascript:get_content('student/student_action')">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#34B334;">
                        ...
                        <a href="javascript:get_content('student/student_action')" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ url('student/student_profile_update') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#003366;">
                        ...
                        <a href="{{ url('student/student_profile_update') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            {{-- {{-- <a href="{{ url('student/student_mapping_data_update') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#FF7373;">
                        ...
                        <a href="{{ url('student/student_mapping_data_update') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a> --}}
            <a href="{{ url('student/student_photo_update') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#daa520;">
                        ...
                        <a href="{{ url('student/student_photo_update') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            {{-- <a href="{{ url('student/student_sms_contact_update') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#D67BBC;">
                        ...
                        <a href="{{ url('student/student_sms_contact_update') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/student_sms_notification_update') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#585858;">
                        ...
                        <a href="{{ url('student/student_sms_notification_update') }}" class="small-box-footer">More
            ...
            <a href="{{ url('student/rfid_card_generate') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#40e0d0;">
                        ...
                        <a href="{{ url('student/rfid_card_generate') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ url('student/student_roll_no') }}">
                <div class="col-md-3 col-md-6" style="display:none;">
                    <div class="small-box" style="background-color:	#FF7E00;">
                        ...
                        <a href="{{ url('student/student_roll_no') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{ url('student/donation_student_add') }}">
                <div class="col-md-3 col-md-6" style="display:none;">
                    <div class="small-box" style="background-color:#8040FF;">
                        ...
                        <a href="{{ url('student/donation_student_add') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/student_id_card') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#804040;">
                        ...
                        <a href="{{ url('student/student_id_card') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/guardian_student_id_card') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#FF6848;">
                        ...
                        <a href="{{ url('student/guardian_student_id_card') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/father_student_id_card') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#12C8fA;">
                        ...
                        <a href="{{ url('student/father_student_id_card') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/mother_student_id_card') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#02C87A;">
                        ...
                        <a href="{{ url('student/mother_student_id_card') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/health_zone') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#551B8C;">
                        ...
                        <a href="{{ url('student/health_zone') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{ url('student/physical_fitness') }}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#72A0C1;">
                        ...
                        <a href="{{ url('student/physical_fitness') }}" class="small-box-footer">More Info <i
                                class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
