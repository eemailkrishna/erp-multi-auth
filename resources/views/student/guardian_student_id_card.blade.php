...
<script type="text/javascript">
    function for_section(id) {
        ...
        $.ajax({
            type: "get",
            url: '{{ url('/student/guardian_student_id_card_generate_section') }}/' + id,
            cache: false,
  ...
  $(document).ready(function() {
      $("#student_class").change(function() {
          ...
          $.ajax({
              ...
              url: '{{url('/student/guardian_team_creation_list_post')}}/'+class_id,
              type: 'get',
      ...
      $("#student_section").change(function() {
          ...
          $.ajax({
              url: '{{url('/student/guardian_student_team_creation_list_post_section')}}/' + section_id,
              type: 'get',
              success: function(response) {
                  $('#table-data').html(response.output);
                  $('#section').html(response.section);
