...
<!------------------------------------------------Start Personal Detail--------------------------------------------------->
			<form role="form" action="{{url('category-add')}}" method="post" id="my_form" enctype="multipart/form-data">
      @csrf
            <div class="box-body">
				<div class="col-md-12">
				...
				<div class="form-group">
                  ...
                  <input type="text" name="name" placeholder="Category Name" value="" id="" class="form-control" required />
                </div>
