...
//     $.ajax({
//         type: "get",
//         url: "{{url('ajax-move-student-page')}}/" + value1,
//         cache: false,
...
<section class="content">
    ...
    <form role="form" action="{{url('promotion-student')}}" id="my_form" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8 table table-bordered table-striped  text-center from_table"
                                id="from_student_list">
                                <table id="student" class="table text-center" style="display:none;">
                                    <thead>
                                        <tr>
                                            <th>S No</th>
                                            <th>Student Name</th>
                                    ...
                                    <tbody id="details-container" class="details">
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="checkbox" value="{{$stu->id}}" class="all_check"
                                                    name="move_student_from[{{$stu->id}}]">
                                            </td>
                                        </tr>
                                        @endforeach
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-8 table table-bordered table-striped  text-center to_table"
                                id="to_student_list">
                                <table id="student" class="table" style="display:none;">

                                    <div class="col-md-8 table-bordered table-striped  text-center to_table"
                                        id="to_student_list">
                                        <table id="student" class="table" style="display:none;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Student Name</th>
                                                    <th>Father Name</th>
                                                    <th><input type="checkbox" id="all_check"
                                                            onclick="for_check(this.id);" checked>
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody id="details-container" class="to_details">
                                                @foreach($students as $stu)
                                                <tr>
                                                    <th>{{$loop->iteration}}</th>
                                                    <td>{{$stu->mother_name}}</td>
