...
<div class="col-md-12">
    <center><button type="button" class="btn btn-success"
            onclick="post_content('sports/download_category_list','age_category=60&student_class=All&gender=All&date_search=2022-12-05')">Print</button>
    </center>
</div>
<script>
$(function() {
