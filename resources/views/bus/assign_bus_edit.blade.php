...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			<form action="{{url('bus-assign-update/'.$test->id)}}" method="post" id="my_form" enctype="multipart/form-data">@csrf
            <div class="box-body">
			 ...
			 <div class="col-md-4 ">				
			  <div class="form-group" >
				 ...
				 <select class="form-control" name="bus_no" required>
				 					...
				 					<option value="{{$test->bus_no}}">{{$test->bus_no}}</option>
			  ...
			  <div class="form-group" >
				 ...
				 @foreach($route as $list)
				 					...
				 					<option value="{{$list->bus_route}}">{{$list->bus_route}}</option>
