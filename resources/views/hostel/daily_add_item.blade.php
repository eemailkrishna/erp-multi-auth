 ...
 <div class="row">
          ...
          <div class="box box-warning  ">
            <div class="box-header with-border ">
              <h3 class="box-title" style="color:#930F4B">Add Item Daily Purchase</h3>
            </div>
            <!-- /.box-header -->
...
<!------------------------------------------------Start Registration form--------------------------------------------------->
    ...
    <div class="panel panel-default">
      <div id="my_table" class="panel-heading"><span style="font-size:18px;">Add Item Daily Purchase</span>
        <input type ="date" style="margin-left:170px;" name="date_purchase" value="2022-12-05"></div>
