    ...
    <div class="row">
        ...
        <div class="box box-primary my_border_top">
            ...
            <div class="box-header with-border ">
                <h3 class="box-title">Views Form</h3>
            </div>
            <!-- /.box-header -->
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="hostel_student_religion" id="student_religion"
                                    placeholder="Religion" value="{{ $views->religion }}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="hostel_student_category" id="student_category"
                                    placeholder="Category" value="{{ $views->category }}" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-4 ">
                            <div class="form-group">
                        ...
                        <div class="col-md-4 ">
                            <div class="form-group">
                                ...
                                <input type="text" name="hostel_student_mother_contact"
                                    id="student_mother_contact_number" placeholder="Mother Contact No" value="{{ $views->mother_contact_no }}"
                                    class="form-control">
                            </div>
                        </div>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="hostel_mess_charge" value="{{ $views->mess_charge }}" placeholder="Mess Charge">
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="form-group">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="hostel_caution_money"  placeholder="Caution Money"
                                value="{{ $views->caution_money }}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <input type="text" name="hostel_laundry_charge" placeholder="Laundry Charge"
                                value="{{ $views->laundry_charge}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12 ">
                        <div class="form-group">
                            <center><button type="submit" name="submit" class="btn btn-success">Views</button></center>
                        </div>
                    </div>
                </div>
                </form>
