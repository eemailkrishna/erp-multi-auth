                ...
                <tbody id="tbody">
                    @foreach ($users as $item )
                        <tr>
                            ...
                            @if ($item->seat_availablity <= "seat_availablity")
                            <td>seat available</td>
                            @else
                            <td>seat not available</td>
                            @endif
                            <td><a href="{{ url('hostel-room-add-detail') }}"><button type="submit" class="btn btn-danger">Add Room</button></a>
                                {{-- <button type="submit" class="btn btn-danger">Seat Add </button> --}}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
    ...
    $(document).ready(function() {
        $("#hostel_name").on('change', function() {
            ...
            $.ajax({
                ...
                <td>\
                    <a href=""<button type="submit" class="btn btn-danger">Add Room</button></a>\
                    </td>\
                 </tr>'
                        }
                    } else {
