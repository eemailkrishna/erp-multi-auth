...
<!------------------------------------------------Start Registration form--------------------------------------------------->
    ...
    <div class="panel panel-default">
	 ...
	 <div class="form-group">
		...
		<input type="text" name="roll_number" placeholder="Roll_No" value="{{ $leave->student->roll_no }}" class="form-control" readonly>
		<input type="hidden" name="hostel_student_id" placeholder="Student Name" value="0_7" class="form-control" readonly>
	</div>

	<div class="form-group">
		<label>student Name</label>
		<input type="text" name="hostel_student_name" value="{{ $leave->user->name }}" class="form-control" readonly>
	</div>
	<div class="form-group">
		<label>Room No.</label>
		<input type="text" name="room_number" value="{{ $leave->hostal_room_details->hostal_room_no}}" class="form-control" readonly>
	</div>
	<div class="form-group">
