...
<!------------------------------------------------Start Registration form--------------------------------------------------->
            ...
            <div class="box-body "  >
			<form action="{{url('penalty-form')}}" method="post" enctype="multipart/form-data" id="my_form">
			@csrf		
			<div class="col-md-12">
			<div class="col-md-6 ">				
					<div class="form-group" >
					  ...
					  <select name="student_search"  class="form-control select2" onchange="fill_detail(this.value);" style="width:100%;" >
		       ...
		       <div class="col-md-3">
						<div class="form-group">
						  <label>student Name<font style="color:red"><b>*</b></font></label>
						   <input type="text" name="student_name" value="" placeholder="student Name"  id="student_name" class="form-control">
						</div>
				</div>
				<div class="col-md-3">
						<div class="form-group">
						  <label>Class<font style="color:red"><b>*</b></font></label>
						   <input type="text" name="student_class" value="" placeholder="Class"  id="student_class" class="form-control">
						</div>
				</div>
				<div class="col-md-3">
						<div class="form-group">
						  <label>Student Section<font style="color:red"><b>*</b></font></label>
						  <input type="text" name="student_section" value="" placeholder="Student Section"  id="student_section" class="form-control">
						</div>
				</div>
				<div class="col-md-3">	
					<div class="form-group" >
					  <label>Student Roll No<font style="color:red"><b>*</b></font></label>
					  <input type="text" name="student_roll_no" value="" placeholder="Student Roll No"  id="student_roll_no" class="form-control">
					</div>
				</div>  
				<div class="col-md-3">	
					<div class="form-group" >
					  <label>Penalty Amount<font style="color:red"><b>*</b></font></label>
					  <input type="text" name="penalty_amount" placeholder="Penalty Amount"  value="" class="form-control" required>
					</div>
				</div>
				<div class="col-md-3">	
					<div class="form-group" >
					  <label>Penalty Reason<font style="color:red"><b>*</b></font></label>
					  <input type="text" name="penalty_reason" placeholder="Penalty Reason"  value="" class="form-control" required>
					</div> 
				</div>
				<div class="col-md-3">	
					<div class="form-group" >
