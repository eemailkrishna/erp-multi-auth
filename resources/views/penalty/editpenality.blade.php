...
<!------------------------------------------------Start Registration form--------------------------------------------------->
			...
			<div class="col-md-6 ">				
					<div class="form-group" >
					  ...
					  <select name="student_search" value="{{$editp->student_search}}" class="form-control select2" onchange="fill_detail(this.value);" style="width:100%;" >
					  <option value="{{$editp->student_search}}">Select student</option>
