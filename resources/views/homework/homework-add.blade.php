...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url('/homework-list')}}"><i class="fa fa-book"></i> Homework-List</a></li>
        <li class="active"><i class="fa fa-user-plus"></i> Add H/W</li>
    </ol>
</section>

<form role="form" action="{{url('add-homework-que')}}" method="post" enctype="multipart/form-data">
    @csrf
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Date</label>
                <input type="date" value="" name="hw_date" id="myLocalDate" placeholder="Date" value=""
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Remark</label>
                <input type="text" name="hw_remark" placeholder="Remark" value="" class="form-control" required>
                <span class="text-danger">
                    @error('hw_remark')
                    {{$message}}
                    @enderror
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="file" name="hw_image" id="student_photo" placeholder=""
                    ...
                    accept=".gif, .jpg, .jpeg, .png, .pdf, .doc" value="" required>
            </div>
        </div>
        <div class="col-md-1">
            <div class="form-group">
                <img id="show_student_photo" src='/images/student_blank.png' width='60px' height='60px'>
            </div>
        </div>
    </div>
    <div class="col-md-12">
        <div class="box box-info">
            ...
            <div class="box-body pad">
                ...
                <textarea id="" name="write_homework" class="form-control bordder-color" placeholder="write homework"
                    rows="12" cols="80" required></textarea>
