                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="file" name="cw_image" id="student_photo" placeholder=""
                                    onchange="check_file_type(this,'student_photo','show_student_photo','all');"
                                    class="form-control" accept=".gif, .jpg, .jpeg, .png, .pdf, .doc" value="">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
                                <img id="show_student_photo"
                                    src="{{asset('images/homeworks/'.$classwork->classwork_image)}}" width="60px"
                                    height="50px" alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body pad">
                                ...
                                <textarea name="write_classwork" class="form-control bordder-color"
                                    placeholder="write homework here" rows="10" cols="80">{{$classwork->classwork_write}}
                                </textarea>
                            </div>
                        </div>
                        <!-- /.box -->
