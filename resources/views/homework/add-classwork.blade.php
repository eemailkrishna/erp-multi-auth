...
<form role="form" method="post" enctype="multipart/form-data" id="my_form" action="{{url('add-classwork-que')}}">
    ...
    <div class="col-md-12">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Remark</label>
                <input type="text" name="cw_remark" placeholder="Remark" value="" class="form-control" required>
                <span class="text-danger">
                    @error('cw_remark')
                    {{$message}}
                    @enderror
        ...
        <div class="col-md-3">
            <div class="form-group">
                <label>Class Work Image</label>
                <input type="file" name="cw_image" id="student_photo" placeholder=""
        ...
        <div class="box box-info">
            ...
            <div class="box-body pad">
                ...
                <textarea id="" name="write_classwork" class="form-control bordder-color"
                    placeholder="write class work here" rows="12" cols="80" required></textarea>
