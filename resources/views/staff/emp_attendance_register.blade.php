			  ...
			  <div class="panel-body">
				...
				<tbody id="priority">
                    @foreach ($attendance as $data )
								...
								<tr>
				<td><b>{{ $loop->iteration }}</b><input type="hidden" name="emp_id[]" class="form-control" value="19" readonly /></td>

				<td><input type="checkbox" class="checked1" checked value="0" name="emp_index[]"></td>
				<td><input type="text" name="emp_name[]" class="form-control" value="{{ $data->emp_name }}" readonly /></td>
				<td>
				...
				<tr>
				<td colspan="6" style="text-align: center;"><input type="submit" name="submit" value="Update" onclick="return validation();" class="btn btn-success" /></td>
				</tr>
