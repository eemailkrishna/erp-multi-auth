...
<!-- daterangepicker -->
<!-- DataTables -->
<script src="{{url('assests/js/jquery-3.6.0.min.js')}}"></script>
<script src="{{url('assests/js/bootstrap.bundle.js')}}"></script>
<script src="{{url('assests/js/bootstrap.bundle.min.js')}}"></script>
<script src="{{url('assests/js/bootstrap.esm.js')}}"></script>
<script src="{{url('assests/js/bootstrap.esm.min.js')}}"></script>
<script src="{{url('assests/js/bootstrap.js')}}"></script>
<script src="{{url('assests/js/bootstrap.min.js')}}"></script>
...
<!-- sweet alert cdn -->
<script src="{{url('assests/js/sweetAlert.js')}}"></script>
...
<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2022-2023 <a href="http://www.kutumbhhrcare.com/" target="_blank">Kutumbh Care Pvt.
...
<script src="{{url('assests/js/file_check.js')}}"></script>

<!--  newnewnewnenwenwnenwnenwnew -->
            ...
            success: function(response) {
                if (response['sections'].length > 0) {
                    $.each(response['sections'], function(key, value) {
                        $("#section").append("<option id='" + value[
