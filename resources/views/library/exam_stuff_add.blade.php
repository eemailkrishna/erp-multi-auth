			...
			<form id="my_form" role="form" method="post" enctype="multipart/form-data">
				...
				<div class="col-md-12 ">				
			       <div class="form-group" >
				    <label >Subject Name</label>
				     <!-- <select class="form-control" name="exam_stuff_subject" id="subject_name" > -->
				      <!-- <option value="">Select Subject</option> -->
				  <input type="text" name="subject_name" placeholder="subject Name"  value="" class="form-control" required>
			  ...
			  <div class="col-md-12 ">		
				...
				<div class="col-md-12 ">				
					 <div class="form-group" >
					  <label>Date</label>
						<input type="date" class="form-control" name="exam_stuff_date" placeholder="Publish Date" required/> 
					 </div>
				</div>
			          <div class="col-md-9">	
					<div class="form-group">
				...
				<div class="col-md-3">	
					<div class="form-group">
					   <img id="show_upload_file" src='../school_software_v1_old/images/student_blank.png' width='60px' height='60px'>
					</div>
				</div>
				</div>
