...
$.ajax({
type: "POST",
url: access_link+"time_table/diff_ajax_time_table_list.php?class="+class_name+"&section="+class_section+"&student_class_stream="+student_class_stream+"&student_class_group="+student_class_group+"",
cache: false,
success: function(detail){
