...
<section class="content">
    <div <div class="box box-success">
        <div class="box-header with-border">
            ...
            <h3 class="box-title" style="color:teal;"><i class="fa fa-book"></i>&nbsp;&nbsp;&nbsp;<b>Time Table For Same
                    Period Timing for All Class</b></h3>
        </div>
        <div class="box-body">
            <a href="{{url('time_table/add_class_period')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#33E6E6;">
                        ...
                        <div class="icon">
                            <i class="ion"><img src="{{url('images/time_table_panel.png')}}"
                                    style="width:70px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "
                                    title="School Management System" class="image1"></i>
                        </div>
                        <a href="{{url('time_table/add_class_period')}}" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            <a href="{{url('time_table/subject_wise_teacher')}}">
                <div class="col-md-3 col-md-6">
            ...
            <a href="{{url('time_table/time_table_generate')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        ...
                        <a href="{{url('time_table/time_table_generate')}}" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{url('time_table/time_table_list')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        ...
                        <div class="icon">
                            <i class="ion"><img src="{{url('images/time_table_list.png')}}"
                                    style="width:70px;margin-bottom:20px;" alt="Simption Tech Pvt Ltd "
                                    title="School Management System" class="image1"></i>
                        </div>
                        <a href="{{url('time_table/time_table_list')}}" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
            ...
            <a href="{{url('time_table/teacher_availability')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B7A57;">
                        ...
                        <div class="icon">
                            <i class="ion"><img src="{{url('images/teacher_availablity.png')}}"
            ...
            <a href="{{url('time_table/teacher_assign')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#3B6AA7;">
                        ...
                        <a href="{{url('time_table/teacher_assign')}}" class="small-box-footer">More Info
                            <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>

            <a href="{{url('time_table/time_table_sheet')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#808000;">
                        ...
                        <a href="{{url('time_table/time_table_sheet')}}" class="small-box-footer">More
                            Info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </a>
    ...
    <div <div class="box box-success">
        <div class="box-header with-border">
            ...
            <h3 class="box-title" style="color:teal;"><i class="fa fa-book"></i>&nbsp;&nbsp;&nbsp;<b>Time Table For
                    Diffrent Period Timing for Different Class(Teacher Availablity, Teacher Management And TimeTable
                    Sheet is not possible for different period timing)</b></h3>
        </div>
        <div class="box-body">
            <a href="{{url('time_table/diff_add_class_period')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#33E6E6;">
                        <div class="inner"><br>
                            <h3 style="font-size:18px;margin-left:10px;color:#fff;">Class Period</h3>
            ...
            <a href="{{url('time_table/diff_time_table_generate')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#E32636;">
                        <div class="inner"><br>
                            <h3 style="font-size:18px;margin-left:10px;color:#fff;">Time Table</h3>
            ...
            <a href="{{url('time_table/diff_time_table_list')}}">
                <div class="col-md-3 col-md-6">
                    <div class="small-box" style="background-color:#9F2B68;">
                        <div class="inner"><br>
                            <h3 style="font-size:18px;margin-left:10px;color:#fff;">Time Table List</h3>
